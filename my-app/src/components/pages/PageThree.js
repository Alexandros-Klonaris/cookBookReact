...
export default function PageThree() {
    return (
        ...
        <li>Add the Yogurt, If Using. I do think that using banana-flavored Greek yogurt makes a difference in this smoothie. The tangy-sweet flavor and thick, creamy texture of Greek yogurt is really good! But if you don’t have or want to use yogurt, feel free to leave it out.</li><br/>
